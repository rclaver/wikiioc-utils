...
print(CB_CYN+"==================================================================")
print(CB_CYN+" Reorganització dels fitxers exportats dels projectes activityutil")
print(CB_CYN+"=================================================================="+C_NONE)
...
def sintaxi():
	...
	print(CB_GRN+"           valors de key: "+CB_CYN+"[mdprojects, pages, activity_dir, prefix, simulació]")
...
def actualParams():
	global MDPROJECTS, PAGES, ACTIVITY_DIR, PREFIX, SIMULACIO
	...
	for file in listFiles:
		...
		if (file == page_project):
			...
			if (not os.path.exists(destination)):
				...
				print(CB_CYN+"          a destí ["+CB_GRN+destination+CB_CYN+"]"+C_NONE)
				if (SIMULACIO == "E"):
					os.rename(origin, destination)
			else:
				print(CB_RED+"    eliminant origen ["+CB_GRN+origin+CB_CYN+"]"+C_NONE)
				if (SIMULACIO == "E"):
					shutil.rmtree(origin, ignore_errors=True)

			print(CB_CYN+"    creant link de destí ["+CB_GRN+destination+CB_CYN+"]"+C_NONE)
